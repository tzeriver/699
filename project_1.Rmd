...
### Logistic Regression
```{r}
prostate_logreg <- glm(`Erectile Function at 2 years` ~ Age + `Gleason Score` + `T-Stage Group` + PSA + HRQOL + ADT + BMI + `Erectile Function at Baseline`, family = binomial(link = "logit") ,data = prostate)
